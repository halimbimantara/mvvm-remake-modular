...
import com.mindorks.framework.mvvm.databinding.ItemOpenSourceEmptyViewBuilderBinding;
import com.mindorks.framework.mvvm.databinding.ItemOpenSourceViewBinding;
import com.mindorks.framework.mvvm.databinding.ItemOpenSourceViewBuilderBinding;
...
public class OpenSourceAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemOpenSourceViewBuilderBinding openSourceViewBinding = ItemOpenSourceViewBuilderBinding
                        .inflate(LayoutInflater.from(parent.getContext()), parent, false);
                return new OpenSourceViewHolder(openSourceViewBinding);
            case VIEW_TYPE_EMPTY:
            default:
                ItemOpenSourceEmptyViewBuilderBinding emptyViewBinding = ItemOpenSourceEmptyViewBuilderBinding
                        .inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class EmptyViewHolder extends BaseViewHolder implements OpenSourceEmptyItemViewModel.OpenSourceEmptyItemViewModelListener {
        ...
        private final ItemOpenSourceEmptyViewBuilderBinding mBinding;

        public EmptyViewHolder(ItemOpenSourceEmptyViewBuilderBinding binding) {
    ...
    public class OpenSourceViewHolder extends BaseViewHolder implements View.OnClickListener {
        ...
        private final ItemOpenSourceViewBuilderBinding mBinding;

        public OpenSourceViewHolder(ItemOpenSourceViewBuilderBinding binding) {
            super(binding.getRoot());
            this.mBinding = binding;
        }

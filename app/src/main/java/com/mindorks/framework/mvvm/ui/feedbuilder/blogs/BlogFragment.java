...
import com.mindorks.framework.mvvm.databinding.FragmentBlogBuilderBinding;
...
public class BlogFragment extends BaseFragmentOld<FragmentBlogBuilderBinding, BlogViewModel>
        implements BlogNavigator, BlogAdapter.BlogAdapterListener {

    @Inject
    BlogAdapter mBlogAdapter;
    FragmentBlogBuilderBinding mFragmentBlogBinding;
    @Inject
    ...
    public int getLayoutId() {
        return R.layout.fragment_blog_builder;
    }

    @Override
    public BlogViewModel getViewModel() {
        mBlogViewModel = new ViewModelProvider(this, factory).get(BlogViewModel.class);

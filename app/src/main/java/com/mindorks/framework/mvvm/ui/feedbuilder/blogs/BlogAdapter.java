...
package com.mindorks.framework.mvvm.ui.feedbuilder.blogs;
...
import com.mindorks.framework.mvvm.databinding.ItemBlogEmptyViewBuilderBinding;
import com.mindorks.framework.mvvm.databinding.ItemBlogViewBuilderBinding;
...
public class BlogAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemBlogViewBuilderBinding blogViewBinding = ItemBlogViewBuilderBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
                return new BlogViewHolder(blogViewBinding);
            case VIEW_TYPE_EMPTY:
            default:
                ItemBlogEmptyViewBuilderBinding emptyViewBinding = ItemBlogEmptyViewBuilderBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
    ...
    public class BlogViewHolder extends BaseViewHolder implements BlogItemViewModel.BlogItemViewModelListener {
        private ItemBlogViewBuilderBinding mBinding;
        private BlogItemViewModel mBlogItemViewModel;


        public BlogViewHolder(ItemBlogViewBuilderBinding binding) {
    ...
    public class EmptyViewHolder extends BaseViewHolder implements BlogEmptyItemViewModel.BlogEmptyItemViewModelListener {
        private ItemBlogEmptyViewBuilderBinding mBinding;

        public EmptyViewHolder(ItemBlogEmptyViewBuilderBinding binding) {
            super(binding.getRoot());
            this.mBinding = binding;
        }
